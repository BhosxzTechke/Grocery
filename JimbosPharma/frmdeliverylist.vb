...
Public Class frmdeliverylist
    ...
    Private Sub frmdeliverylist_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ' Set the minimum date to today when the form loads
        ddate.MinDate = DateTime.Today
    ...
    Private Sub ddate_ValueChanged(sender As Object, e As EventArgs) Handles ddate.ValueChanged
        ' Ensure the user cannot select a date earlier than the last recorded delivery date
        If ddate.Value < ddate.MinDate Then
            MessageBox.Show("Delivery date cannot go back!", "Invalid Date", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            ddate.Value = ddate.MinDate ' Reset to minimum allowed date
        End If
    End Sub
End Class
