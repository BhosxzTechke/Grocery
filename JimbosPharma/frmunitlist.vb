...
Public Class frmunitlist
    ...
    Private Sub dataprod_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dataunit.CellContentClick
        ...
        ElseIf colname = "Delete" Then
            ...
            Guna2MessageDialog1.Caption = "Confirm Delete"
            ...
            If result = DialogResult.Yes Then
                Try
                    ...
                    Guna2MessageDialog1.Caption = "Delete Successful"
                    Guna2MessageDialog1.Text = "Record has been successfully deleted."
    ...
    Private Sub searchboxing_TextChanged(sender As Object, e As EventArgs)
        SearchUNIT()
    End Sub
End Class