...
Public Class cashier
    ...
    Sub computesalesdetail(ByVal _total As Double)
        ...
        lbltotal.Text = Format(_total, "#,##0.00")  ' Total amount of every item hindi pa nilalagay ung mga discount

        ' Calculate the subtotal
        lblsubtotal.Text = Format(CDbl(lbltotal.Text) - CDbl(lbldics.Text), "#,##0.00") ' Total amount that if have discount apply it
        ...
        frmsettle.SalesData.VAT = CDbl(lblvat.Text) ' store the vat value For Print
    ...
    Private Sub lblinvoice_Click(sender As Object, e As EventArgs) Handles lblinvoice.Click, lblcashier.Click
