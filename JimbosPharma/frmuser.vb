...
Public Class frmuser
    ...
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        Try
            ...
            If Not IsStrongPassword(txtpass.Text) Then
                Guna2MessageDialog1.Text = "Must be at least 8 characters with uppercase, lowercase, a number, and a special character (@$!%?&), or an 8-digit numeric password."
                Guna2MessageDialog1.Show()
